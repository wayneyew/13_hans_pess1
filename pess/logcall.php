...
{
	var x=documant.forms["frmLogCall"]["callerName"].value;
	if (x==null || x=="")
	{
...
while ($row = $resultset->fetch_assoc()) {
	// create an associative array of $incidentType {incident_type_id,incident_type_id,incident_type_desc]
...
<form name="frmLogCall" method="post"
	onSubmit="return validateFrom()" action="dispatch.php">
	<table class="ContentStyle">
		...
		<tr>
			<td>Contact No :</td>
			<td><input type="text" name="contactNo" id="contectNo"></td>
		</tr>
		<tr>
			<td>Location  :</td>
